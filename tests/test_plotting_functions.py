...
def test_axis_plots(premade_br, premade_big_br):
    ...
    bpf.show_nstep_pdf(axs[1], br, axs[0], fig=fig, offset=offset)
    ...
    bpf.show_nstep_pdf(axs[1], br, axs[0], fig=fig, offset=offset, method="hmm", hmm=hmm)
