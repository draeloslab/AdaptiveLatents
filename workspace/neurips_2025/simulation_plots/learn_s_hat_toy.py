...
def single_make_srs(rng):
    ...
    sr1 = StimRegressorWithExtraLogging(autoreg=StreamingKalmanFilter(), log_level=2, check_dt=True)
    sr2 = StimRegressorWithExtraLogging(autoreg=StreamingKalmanFilter(), log_level=2, check_dt=True, attempt_correction=False)
    sr3 = StimRegressorWithExtraLogging(autoreg=StreamingKalmanFilter(), log_level=2, check_dt=True, attempt_correction=False, heed_stimuli=False)
